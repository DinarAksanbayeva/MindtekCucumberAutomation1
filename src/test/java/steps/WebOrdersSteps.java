...
public class WebOrdersSteps {
    ...
    public void user_creates_order_with_data(DataTable dataTable) {
        //For automatic transformation,change DatTable to one of List<>E,List<List><E>>
        ...
        webOrdersOrderPage.expireDate.sendKeys(data.get(0).get("expired date").toString());
    ...
    public void userValidatesOrderAddedToListOfOrders() {
        ...
        String actualName=webOrdersHomePage.firsName.getText();
